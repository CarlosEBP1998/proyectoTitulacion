...
entrantes_sem1 = [randint(590, 610) for _ in range(num_rows//2)] # Número de estudiantes que entran
bajas_temp_sem1 = [randint(190, 210) for _ in range(num_rows//2)] # Número de bajas temporales
bajas_def_sem1 = [randint(90, 110) for _ in range(num_rows//2)] # Número de bajas definitivas
...
entrantes_sem2 = [randint(690, 710) for _ in range(num_rows//2, num_rows)] # Número de estudiantes que entran
bajas_temp_sem2 = [randint(240, 260) for _ in range(num_rows//2, num_rows)] # Número de bajas temporales
bajas_def_sem2 = [randint(110, 130) for _ in range(num_rows//2, num_rows)] # Número de bajas definitivas
